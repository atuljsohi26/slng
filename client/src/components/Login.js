    ...
    >
      <div className="flex flex-col items-center mt-10 space-y-32">
        ...
        <div className="grid grid-cols-2 gap-28">
          <div className="h-96 w-96 space-y-11 shadow-2xl flex flex-col justify-center items-center bg-transparent backdrop-blur-sm bg-[#5a51d6] bg-opacity-60 rounded-xl">
          ...
          <div className="h-96 w-96 space-y-11 shadow-2xl flex flex-col justify-center items-center bg-transparent backdrop-blur-sm bg-[#d65158] bg-opacity-60 rounded-xl">
